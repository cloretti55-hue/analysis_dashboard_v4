    ...
    images: [
      {
        ...
        title: "When Equities Struggle",
        comment: "An introduction to equity crises and wealth protection.",
      },
      {
      ...
      },
      {
        ...
        comment: "The questions and trade-offs involved in combining portfolio hedges.",
      },
      {
        src: "assets/themes/retail-portfolio-problem.png",
        title: "The Retail Portfolio Problem",
        comment: "Portfolio construction and the challenges faced by retail investors.",
      },
      {
        src: "assets/themes/dynamic-risk-management.png",
        title: "Dynamic Risk Management",
        comment: "An overview of dynamic approaches to managing portfolio risk.",
      },
      {
        src: "assets/themes/risk-parity-balance-risk-not-capital.png",
        title: "Risk Parity — Balance Risk, Not Capital",
        comment: "Risk parity and the distinction between capital allocation and risk allocation.",
      },
      {
        src: "assets/themes/managed-futures-systematic-diversification.png",
        title: "Managed Futures & Systematic Diversification",
        comment: "Managed futures within the discussion of systematic portfolio diversification.",
      },
      {
        src: "assets/themes/how-much-should-alternatives-weigh.png",
        title: "How Much Should Alternatives Weigh?",
        comment: "The question of alternative strategy weights in a portfolio.",
      },
      {
        src: "assets/themes/portable-alpha-vs-beta-enhancement.png",
        title: "Portable Alpha vs. Beta Enhancement",
        comment: "A comparison of portable alpha and beta enhancement approaches.",
      },
      {
        src: "assets/themes/yale-model.png",
        title: "The Yale Model",
        comment: "An introduction to the Yale endowment model of portfolio construction.",
      },
    ],
  },
  {
